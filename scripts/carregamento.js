function preload() {
  imagem.fundo = loadImage(caminhoImagem.fundo);
  ...
  imagem.verde = loadImage(caminhoImagem.verde);
  imagem.vermelho = loadImage(caminhoImagem.vermelho);
  imagem.preto = loadImage(caminhoImagem.preto);
